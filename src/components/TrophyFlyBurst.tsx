...
interface Props {
  ...
  /** Time to spawn all visual particles (ms). */
  spawnDurationMs?: number;
  /** Trophy 3D render size (px). */
  iconSize?: number;
  /** Called once per logical trophy when a particle reaches the target. */
...
const DEFAULT_BOX_SIZE = 84;

/**
 * Flies mini 3D trophies from one UI anchor to another (fixed overlay).
 * Caps visible particles; `onArrive` fires for every logical trophy.
 */
export default function TrophyFlyBurst({
  count,
  fromEl,
  toEl,
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              filter: "drop-shadow(0 6px 18px rgba(255,215,0,0.95))",
            }}
          >
